        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-[#E5E5E5] rounded-lg focus:outline-none focus:border-[#FFA500]"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <MapPin className="absolute left-3 top-3 w-5 h-5 text-[#999]" />
              <input
                type="text"
                required
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-[#E5E5E5] rounded-lg focus:outline-none focus:border-[#FFA500]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <DollarSign className="absolute left-3 top-3 w-5 h-5 text-[#999]" />
              <input
                type="number"
